...
const Footer: React.FC = () => {
  return (
    <footer className="bg-booking-secondary text-white py-12">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">BookingApp</h3>
            <p className="text-gray-300 text-sm mb-4">
              Find your perfect stay with our handpicked selection of
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/licenses" className="text-gray-300 hover:text-white">
                  Licenses
                </Link>
              </li>
            </ul>
